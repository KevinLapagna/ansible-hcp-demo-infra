...
# BEGIN ANSIBLE MANAGED BLOCK - witty_coyote

# witty coyote VM Instance - Added by Ansible
module "witty_coyote_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "witty-coyote-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - witty_coyote
