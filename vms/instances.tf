...
# BEGIN ANSIBLE MANAGED BLOCK - modest_ocelot

# modest ocelot VM Instance - Added by Ansible
module "modest_ocelot_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "modest-ocelot-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - modest_ocelot
