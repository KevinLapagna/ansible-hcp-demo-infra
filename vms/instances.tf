# BEGIN ANSIBLE MANAGED BLOCK - cosmic_dane
resource "aws_instance" "cosmic_dane_vm" {
  ...
  tags = {
    Name        = "cosmic-dane-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
    RequestID   = "REQ111106192"
  }
}
# END ANSIBLE MANAGED BLOCK - cosmic_dane
