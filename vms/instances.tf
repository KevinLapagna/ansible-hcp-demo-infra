...
# BEGIN ANSIBLE MANAGED BLOCK - free_rabbit
resource "aws_instance" "free_rabbit_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "free-rabbit-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Linux"
    RequestID   = "REQ487631736"
  }
}
# END ANSIBLE MANAGED BLOCK - free_rabbit
