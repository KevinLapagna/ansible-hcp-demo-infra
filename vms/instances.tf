# BEGIN ANSIBLE MANAGED BLOCK - flying_teal
resource "aws_instance" "flying_teal_vm" {
  ...
  tags = {
    Name        = "flying-teal-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Linux"
    RequestID   = "REQ769876084"
  }
}
# END ANSIBLE MANAGED BLOCK - flying_teal
