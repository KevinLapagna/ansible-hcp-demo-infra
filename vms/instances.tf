...
# BEGIN ANSIBLE MANAGED BLOCK - immune_flea

# immune flea VM Instance - Added by Ansible
module "immune_flea_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "immune-flea-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - immune_flea
