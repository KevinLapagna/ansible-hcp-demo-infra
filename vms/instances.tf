...
# BEGIN ANSIBLE MANAGED BLOCK - crisp_panda

# crisp panda VM Instance - Added by Ansible
module "crisp_panda_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "crisp-panda-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - crisp_panda
