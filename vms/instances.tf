...
# BEGIN ANSIBLE MANAGED BLOCK - picked_raptor

# picked raptor VM Instance - Added by Ansible
module "picked_raptor_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "picked-raptor-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - picked_raptor
