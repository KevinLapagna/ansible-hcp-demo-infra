...
# BEGIN ANSIBLE MANAGED BLOCK - saving_beetle

# saving beetle VM Instance - Added by Ansible
module "saving_beetle_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "saving-beetle-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - saving_beetle
