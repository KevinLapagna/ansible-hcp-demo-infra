# BEGIN ANSIBLE MANAGED BLOCK - needed_shrimp
resource "aws_instance" "needed_shrimp_vm" {
  ...
  tags = {
    Name        = "needed-shrimp-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
    RequestID   = "REQ877934469"
  }
}
# END ANSIBLE MANAGED BLOCK - needed_shrimp
