...
# BEGIN ANSIBLE MANAGED BLOCK - moral_crab

# moral crab VM Instance - Added by Ansible
module "moral_crab_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "moral-crab-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - moral_crab
