...
# BEGIN ANSIBLE MANAGED BLOCK - casual_midge

# casual midge VM Instance - Added by Ansible
module "casual_midge_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "casual-midge-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - casual_midge
