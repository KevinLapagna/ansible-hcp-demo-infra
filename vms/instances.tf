...
# BEGIN ANSIBLE MANAGED BLOCK - polite_yak
resource "aws_instance" "polite_yak_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "polite-yak-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Linux"
    RequestID   = "REQ441732098"
  }
}
# END ANSIBLE MANAGED BLOCK - polite_yak
