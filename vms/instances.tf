...
# BEGIN ANSIBLE MANAGED BLOCK - suited_sponge

# suited sponge VM Instance - Added by Ansible
module "suited_sponge_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "suited-sponge-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - suited_sponge
