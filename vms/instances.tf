# BEGIN ANSIBLE MANAGED BLOCK - steady_wombat
resource "aws_instance" "steady_wombat_vm" {
  ...
  tags = {
    Name        = "steady-wombat-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Linux"
    RequestID   = "REQ376118538"
  }
}
# END ANSIBLE MANAGED BLOCK - steady_wombat
# BEGIN ANSIBLE MANAGED BLOCK - alive_hawk
resource "aws_instance" "alive_hawk_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "alive-hawk-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
    RequestID   = "REQ462667023"
  }
}
