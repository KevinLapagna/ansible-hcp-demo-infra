...
# BEGIN ANSIBLE MANAGED BLOCK - amazed_cougar

# amazed cougar VM Instance - Added by Ansible
module "amazed_cougar_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "amazed-cougar-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - amazed_cougar
