...
# BEGIN ANSIBLE MANAGED BLOCK - nearby_goose
resource "aws_instance" "nearby_goose_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "nearby-goose-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
    RequestID   = "REQ657074330"
  }
}
# END ANSIBLE MANAGED BLOCK - nearby_goose
# BEGIN ANSIBLE MANAGED BLOCK - proud_mako
resource "aws_instance" "proud_mako_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "proud-mako-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
    RequestID   = "REQ739908059"
  }
}
# END ANSIBLE MANAGED BLOCK - proud_mako
