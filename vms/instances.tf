...
# BEGIN ANSIBLE MANAGED BLOCK - fine_parrot

# fine parrot VM Instance - Added by Ansible
module "fine_parrot_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "fine-parrot-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - fine_parrot
