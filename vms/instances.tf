...
# BEGIN ANSIBLE MANAGED BLOCK - social_oyster
resource "aws_instance" "social_oyster_vm" {
  provider = aws.eu_central_1
  ...
  tags = {
    Name        = "social-oyster-VM-eu-central-1"
    Environment = "Development"
    CreatedBy   = "AAP"
    Region      = "eu-central-1"
    OsType      = "Windows"
...
# END ANSIBLE MANAGED BLOCK - social_oyster
