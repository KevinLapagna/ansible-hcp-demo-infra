...
# BEGIN ANSIBLE MANAGED BLOCK - better_dingo

# better dingo VM Instance - Added by Ansible
module "better_dingo_vm" {
  source = "./modules/ec2-instance"

  # Required parameters
  instance_name = "better-dingo-VM"
  instance_type = var.instance_type
...
# END ANSIBLE MANAGED BLOCK - better_dingo
